...
- Not a full LMS integration — the QTI output is a file you import manually,
  ...
  caveats in `references/qti-quiz-generation.md`). Always test in a sandbox course
  first.
